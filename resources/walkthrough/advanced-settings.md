...
Customize your BAI experience through the extension settings:
...
- **Auto Model Discovery**: The model picker is automatically filtered to models available on your BAI account.
...
[Manage API Keys](command:bai.manageApiKeys) · [Open Settings](command:bai.openSettings)
