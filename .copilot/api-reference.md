...
> ⚠️ **遇到 Bai API 集成问题（参数 400、协议不兼容、能力标记等）时，优先查看本文档和官方 API 文档**：
> - 官方 API 文档：<https://docs.b.ai/llmservice/api/>
> - 调试时以官网示例（cURL/Node.js）为基准，对比插件请求体差异。
>
> 本文档记录 Bai 平台的 API 地址信息，供扩展开发与调试参考。
> 最后更新：2026-08-06
...
| 项目 | 地址 |
|------|------|
| API 文档 | <https://docs.b.ai/llmservice/api/> |
| 模型列表页 | <https://chat.b.ai/key> |
| 注册 / 获取 API Key | <https://chat.b.ai/chat> |
...
| 文件 | 常量 / 位置 |
|------|-------------|
| `src/apiModelList.ts` | `API_BASE_URL = "https://api.b.ai/v1/"` |
| `src/provider.ts` | `um?.baseUrl \|\| "https://api.b.ai/v1/"` |
| `src/gitCommit/commitMessageGenerator.ts` | `selectedModel.baseUrl \|\| "https://api.b.ai/v1/"` |
| `scripts/check-new-models.mjs` | `API_BASE_URL = "https://api.b.ai/v1/"` |
| `test/api-tests.mjs` | `BASE = "https://api.b.ai/v1"` |

---

## 5. 常见混淆说明

> **models.dev ≠ Bai API 文档**
...
- 扩展**实际请求**走的是上方 `https://api.b.ai/v1` 地址，两者用途不同，勿混淆。
