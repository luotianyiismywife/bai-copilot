 ...
 *
 * 输出名固定为 `bai-copilot-<version>.vsix`（如 bai-copilot-1.10.0.vsix），
 * 与 GitHub Release 附件命名规范及历史发布产物保持一致
 * （见 .copilot/vscode开发经验.instructions.md §1.4）。
 * 注意：发布名用短前缀 `bai-copilot`，不用 package.json 的完整包名
 * `bai-copilot-provider`；也不使用 vsce 默认的 extension.vsix。
 *
 * 用法：npm run build
 */
...
const outFile = `bai-copilot-${pkg.version}.vsix`;
