...
/** How long the status bar stays visible after the last Bai model request. */
const STATUS_BAR_HIDE_DELAY_MS = 60 * 1000; // 1 minute of inactivity
/** Module-level timer for auto-hiding the status bar when Bai models are no longer in use. */
 ...
 * keeps using Bai models and auto-hides once they stop (e.g. switched
